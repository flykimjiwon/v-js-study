...
### 11. 변수,불리언,함수 그리고 그거이용해서 클래스 이해하기 (callback) 꼭복습하고 표시하기 현재(0회복습)

변수 - js_bonus/variable.js

불리언 - js_bonus/boolean.js

함수 - js_bonus/function.js

클래스 - js_bonus/class.js
